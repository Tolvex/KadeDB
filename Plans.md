...
| 1.4 | Implement distributed query execution: query routing to shards, distributed aggregation (map-reduce style), result merging from multiple nodes | Multi-node integration test executes a query across shards and returns correctly merged results | 1.3 | cc:WIP |
